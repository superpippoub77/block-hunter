export function queueLegacyPreloadAssets(scene, logger, preloadSpritesheetConfigs) {
    ...
    scene.load
        ...
        .spritesheet('player_front', 'assets/images/common/player_front.png', preloadSpritesheetConfigs.player_front)
        .spritesheet('player_back', 'assets/images/common/player_back.png', preloadSpritesheetConfigs.player_back)
        .spritesheet('player_right', 'assets/images/common/player_right.png', preloadSpritesheetConfigs.player_right)
        .spritesheet('player_back_right', 'assets/images/common/player_back_rigth.png', preloadSpritesheetConfigs.player_back_right)
