...
$imagesDir = $rootDir . DIRECTORY_SEPARATOR . 'assets' . DIRECTORY_SEPARATOR . 'images' . DIRECTORY_SEPARATOR . 'scenes' . DIRECTORY_SEPARATOR . 'attractmode';
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if ($entries !== false) {
        foreach ($entries as $name) {
            ...
            $list[] = 'assets/images/scenes/attractmode/' . $name;
        }
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'rename') {
        ...
        send_json(200, [
            'ok' => true,
            'oldFile' => 'assets/images/scenes/attractmode/' . $oldName,
            'file' => 'assets/images/scenes/attractmode/' . $newName
        ]);
    }
    ...
    send_json(200, ['ok' => true, 'file' => 'assets/images/scenes/attractmode/' . $fileName]);
}
