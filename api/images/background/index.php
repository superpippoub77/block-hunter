...
$imagesDir = $rootDir . DIRECTORY_SEPARATOR . 'assets' . DIRECTORY_SEPARATOR . 'images' . DIRECTORY_SEPARATOR . 'scenes' . DIRECTORY_SEPARATOR . 'game' . DIRECTORY_SEPARATOR . 'background';
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if ($entries !== false) {
        foreach ($entries as $name) {
            ...
            $list[] = 'assets/images/scenes/game/background/' . $name;
        }
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'rename') {
        ...
        send_json(200, [
            'ok' => true,
            'oldFile' => 'assets/images/scenes/game/background/' . $oldName,
            'file' => 'assets/images/scenes/game/background/' . $newName
        ]);
    }
    ...
    send_json(200, ['ok' => true, 'file' => 'assets/images/scenes/game/background/' . $fileName]);
}
