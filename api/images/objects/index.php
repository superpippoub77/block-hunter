...
$imagesDir = $rootDir . DIRECTORY_SEPARATOR . 'assets' . DIRECTORY_SEPARATOR . 'images' . DIRECTORY_SEPARATOR . 'objects';
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if ($entries !== false) {
        foreach ($entries as $name) {
            ...
            $list[] = 'assets/images/objects/' . $name;
        }
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'rename') {
        ...
        send_json(200, [
            'ok' => true,
            'oldFile' => 'assets/images/objects/' . $oldName,
            'file' => 'assets/images/objects/' . $newName
        ]);
    }
    ...
    send_json(200, ['ok' => true, 'file' => 'assets/images/objects/' . $fileName]);
}
